...
export default function MentionsLegales() {
  return (
    <main>
      ...
      <h3 className="mentions-subtitle">1Infos Editeur</h3>
      <p className="mentions-details">
        Éditeur : le Site est conçu par Benjamin Dollfus, micro-entrepreneur,
        Immatriculée sous le n° Siret 514 928 666 000 48 - Code APE 6201Z - 8B
      ...
      <p className="mentions-details">
        Benjamin Dollfus est le propriétaire exclusif de l’ensemble des éléments
        ayant permis la conception et la réalisation du site.
      </p>
      <p className="mentions-details">
      ...
      <p className="mentions-details">
        ...
        mais accessible par l’ouverture d’une fenêtre, mentionner la source qui
        pointera grâce à un lien hypertexte directement sur le contenu visé, les
        ...
        commerciales ou publicitaires est exclue.
      </p>
      <p className="mentions-details">
      ...
      <p className="mentions-details">
        ...
        lorsque ce dernier n’est pas l’auteur de ces informations. L’Editeur ne
        donne aucune garantie, explicite ou implicite, et n'assume aucune
        responsabilité relative à l'utilisation de la présente publication. En
        aucun cas, l’Editeur ou un tiers impliqué dans la création de ce site ne
        ...
        droit à la vie privée. L’Editeur ne donne pas de garantie quant à la
        ...
        à jour de ces informations. Les autres documents sont présentés à titre
